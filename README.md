...
| HojaDeEstilos        | IHojaDeEstilos                 | Hoja de estilos para utilizar en la generación del archivo de Excel, sino se asigna toma los estilos por defecto |
...
namespace App.Console
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _excel.ExcluirColumnas = new string[] { "Nombre Columna 1", "Nombre Columna 4" };
            _excel.EstilosColumnas = new EstiloColumnas[]
            {
                new EstiloColumnas { Estilo = _excel.HojaEstilos.DATO_NUMERICO, Columnas = new int[] { 0 } },
                new EstiloColumnas { Estilo = _excel.HojaEstilos.DATO_MONEDA, Columnas = new int[] { 8, 10 } },
                new EstiloColumnas { Estilo = _excel.HojaEstilos.DATO_FECHA, Columnas = new int[] { 9, 11 } }
            };
